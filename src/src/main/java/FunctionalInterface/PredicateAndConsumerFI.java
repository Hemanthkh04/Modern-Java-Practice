...
public class PredicateAndConsumerFI {
    ...
    public void printNamesAndActivities(List<Student>student){
         student.forEach(studentConsumer);
    }

    public void PredicateConsumerExample(){
        List<Student>studentList = StudentDataBase.getAllStudents();
        printNamesAndActivities(studentList);
    }
}
